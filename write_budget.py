    ...
    <div style={{ display: \\'flex\\', flexDirection: \\'column\\', gap: \\'20px\\' }} className="max-w-2xl mx-auto pb-10">
      ...
      <div className="rounded-2xl p-6" style={{ background: \\'linear-gradient(145deg, rgba(18,18,20,0.98) 0%, rgba(10,10,12,1) 100%)\\', border: \\'1px solid rgba(255,255,255,0.08)\\' }}>
        ...
        <div className="h-2.5 rounded-full overflow-hidden" style={{ background: \\'rgba(255,255,255,0.07)\\' }}>
          <div className="h-full rounded-full transition-all duration-1000" style={{ width: \\%, background: pct > 90 ? \\'#FF4757\\' : pct > 75 ? \\'#FFB547\\' : \\'#00D68F\\' }} />
        </div>
              ...
              <div key={cat.id}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[12px] text-[#52525B]">
                    {formatPaise(catSpent)}{catLimit > 0 ?  / \\ : \\'\\'}
                  </span>
                </div>
                {catLimit > 0 && (
                  <div className="h-1.5 rounded-full overflow-hidden mb-2" style={{ background: \\'rgba(255,255,255,0.06)\\' }}>
                    <div className="h-full rounded-full transition-all" style={{ width: \\%, background: barColor }} />
                  </div>
                )}
...
'''
with io.open('c:\\Expense Tracker\\app\\(dashboard)\\budgets\\page.tsx', 'w', encoding='utf-8') as f:
    f.write(code)