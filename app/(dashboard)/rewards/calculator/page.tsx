    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }} className="max-w-2xl mx-auto pb-10 page-enter">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="leading-relaxed text-[13px] text-[#52525B] mt-0.5">HDFC MoneyBack+ Points Estimator</p>
        </div>
      </div>
      ...
      <div className="minimal-card rounded-2xl p-6 mt-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1">
            <label className="leading-relaxed block text-[11px] font-bold text-[#52525B] uppercase tracking-widest mb-2">Spend Amount (₹)</label>
          ...
          <div className="flex-[1.5]">
            <label className="leading-relaxed block text-[11px] font-bold text-[#52525B] uppercase tracking-widest mb-2">Where are you spending?</label>
        ...
        {aiReason && (
          <div className="mb-6 p-4 rounded-xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2" style={{ background: 'rgba(147, 51, 234, 0.1)', border: '1px solid rgba(147, 51, 234, 0.2)' }}>
            ...
            <div>
              <p className="leading-relaxed text-[13px] text-slate-200 font-normal mb-1">Gemini Analysis</p>
        ...
        <div className="mb-8">
          <label className="leading-relaxed block text-[11px] font-bold text-[#52525B] uppercase tracking-widest mb-3">Manual Override</label>
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                <p className={`text-[14px] font-bold ${spendType === type.id ? 'text-[#FFD700]' : 'text-slate-200'}`}>{type.label}</p>
                <p className="leading-relaxed text-[11px] text-[#A1A1AA] mt-1">{type.desc}</p>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-xl p-5" style={{ background: 'linear-gradient(145deg, rgba(18,18,20,0.98) 0%, rgba(10,10,12,1) 100%)', border: '1px solid rgba(255,215,0,0.12)' }}>
          <div className="flex items-start justify-between">
            <div>
              <p className="leading-relaxed text-[11px] font-bold text-[#52525B] uppercase tracking-widest mb-1">You Will Earn</p>
              <div className="flex items-baseline gap-2">
                <p className="text-4xl font-bold tracking-tight" style={{ color: '#FFD700' }}>{calcResult.cashpointsEarned}</p>
                <p className="leading-relaxed text-[13px] font-normal text-[#A1A1AA]">Points</p>
              </div>
            </div>
            <div className="text-right">
              <p className="leading-relaxed text-[11px] font-bold text-[#52525B] uppercase tracking-widest mb-1">Value</p>
              <p className="tabular-nums text-xl font-bold text-slate-200">{formatPaise(valuePaise)}</p>
            </div>
          </div>
          
          <div className="leading-relaxed mt-4 pt-4 flex items-center justify-between text-[12px]" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
